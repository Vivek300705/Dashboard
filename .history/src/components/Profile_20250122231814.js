  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#1A1A1A] to-[#D50032] text-white relative">
      ...
      <div className="absolute top-10 left-10 hidden sm:block">
        <div
          className="w-32 h-32 bg-[#D50032] border-4 border-[#FFFFFF] transition-transform duration-300 transform hover:scale-110"
          style={{
      ...
      <div className="absolute bottom-10 right-10 hidden sm:block">
        <div
          className="w-40 h-40 bg-[#D50032] border-4 border-[#FFFFFF] transition-transform duration-300 transform hover:scale-110"
          style={{
