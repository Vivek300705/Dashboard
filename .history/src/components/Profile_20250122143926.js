...
function SecondPage() {
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center justify-center text-white">
      ...
      <div className="text-5xl font-bold mb-6 text-center">Squid Game - Profile</div>
      
      {/* Profile Picture */}
      <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-red-500 mb-6">
        <img
      ...
      <button
        ...
        className="bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-6 rounded-lg shadow-lg transition duration-300 transform hover:scale-105"
      >
