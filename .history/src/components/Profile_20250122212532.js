...
function SecondPage() {
  ...
  const redirectToInstagram = () => {
    window.location.href = "https://www.instagram.com/yourusername"; // Replace with actual Instagram handle
  };
  ...
  return (
    ...
    >
      ...
      >
        <p>
          Name: <strong>Your Name</strong>
        </p>
        <p>
          Registration Number: <strong>1234567890</strong>
        </p>
      </div>
