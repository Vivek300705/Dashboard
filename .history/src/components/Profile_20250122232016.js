...
function SecondPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#1A1A1A] to-[#D50032] text-black relative">
      ...
      <div className="absolute top-10 left-10 hidden sm:block">
        <div className="w-32 h-32 bg-transparent border-4 border-black rounded-full animate-pulse transition-transform duration-300 transform hover:scale-110"></div>
      </div>
      <div className="absolute bottom-10 right-10 hidden sm:block">
        <div className="w-40 h-40 bg-transparent border-4 border-black border-solid transition-transform duration-300 transform hover:scale-110"></div>
      </div>
      <div className="absolute bottom-20 left-10 hidden sm:block">
        <div className="w-32 h-32 bg-transparent border-4 border-black transition-transform duration-300 transform hover:scale-110"></div>
      </div>
    </div>
  );
}
