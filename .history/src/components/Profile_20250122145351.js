...
function SecondPage() {
  ...
  return (
    ...
    >
      ...
      {/* Squid Game Shapes with Hover Zoom Effect */}
      <div className="absolute top-10 left-10">
        <div
          className="w-24 h-24 bg-transparent border-4 border-white rounded-full transition-transform duration-300 transform hover:scale-110"
        ></div>
      </div>
      <div className="absolute bottom-10 right-10">
        <div
          className="w-32 h-32 bg-transparent border-4 border-white border-solid transition-transform duration-300 transform hover:scale-110"
        ></div>
      </div>
      <div className="absolute bottom-20 left-10">
        <div
          className="w-24 h-24 bg-transparent border-4 border-white transition-transform duration-300 transform hover:scale-110"
        ></div>
      </div>
