...
function SecondPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#1A1A1A] to-[#D50032] text-white relative">
      ...
      <div className="text-5xl font-bold mb-8 text-center tracking-wider">
        <span className="text-[#D50032]">Squid</span> Game - Profile
      </div>

      {/* Profile Picture Holder */}
      <div className="w-60 h-60 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-8 border-[#D50032] mb-6">
        <img
      ...
      <button
        ...
        className="bg-[#D50032] hover:bg-[#A10026] text-white font-semibold py-3 px-8 rounded-lg shadow-lg transition duration-300 transform hover:scale-105"
        aria-label="Follow me on Instagram"
      >
        Follow me on Instagram
      </button>

      {/* Squid Game Shapes (Outline) */}
      <div className="absolute top-10 left-10 hidden sm:block">
        <div
          className="w-32 h-32 border-4 border-[#D50032] transition-transform duration-300 transform hover:scale-110"
          style={{
      ...
      <div className="absolute bottom-10 right-10 hidden sm:block">
        <div
          className="w-40 h-40 border-4 border-[#D50032] transition-transform duration-300 transform hover:scale-110"
          style={{
      ...
      <div className="absolute bottom-20 left-10 hidden sm:block">
        <div
          className="w-32 h-32 border-4 border-[#D50032] transition-transform duration-300 transform hover:scale-110"
          style={{
            clipPath: "ellipse(50% 50% at 50% 50%)", // Ellipse shape
          }}
        ></div>
      </div>
    </div>
