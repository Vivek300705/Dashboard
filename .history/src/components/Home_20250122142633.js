  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between p-4 lg:p-8 gap-6">
      ...
      <div className="absolute w-[385px] h-[385px] left-[528px] top-[104px]">
        ...
        {/* Logo (Using <img> tag) */}
        <div className="absolute w-[385px] h-[385px] left-[528px] top-[104px] border border-[#000000] rounded-[15px] flex items-center justify-center">
          <img
            src="https://www.figma.com/design/cxUNv2DykBwnmCxMVC9ECs/Untitled?node-id=2-30&t=JySyAJRbQ6RrFa22-4" // Replace with your logo URL
            alt="E-cell logo"
